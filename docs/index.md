...
| --- | --- | --- | --- |
| [`../README.md`](../README.md) | 用户入口：安装、平台边界、命令组、Skill、license | stable release、安装方式、用户入口或顶层产品定位变化 | npm release / GitHub Release / installed CLI |
...
- **当前安装方式与分发入口**：由 README + npm/GitHub release 事实拥有；Git tag/release 历史不复制进 docs。
