...
struct CollectionGuardTests {
    ...
    func userUUIDCollectionIsEditableForCollectionAndMembershipMutations() throws {
        ...
        #expect(try CollectionWriter.editableTarget(localPK: 1, scope: .collection, on: fixture.handle) == .init(localPK: 1, stableID: "550E8400-E29B-41D4-A716-446655440000"))
        #expect(try CollectionWriter.editableTarget(localPK: 1, scope: .membership, on: fixture.handle) == .init(localPK: 1, stableID: "550E8400-E29B-41D4-A716-446655440000"))
    }
    ...
    func wantToReadIsMembershipOnlyAndOtherSentinelsFailClosed() throws {
        ...
        #expect(try CollectionWriter.editableTarget(localPK: 1, scope: .membership, on: fixture.handle) == .init(localPK: 1, stableID: "Want_To_Read_Collection_ID"))
