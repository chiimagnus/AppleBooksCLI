...
struct AppleBooksFacadeTests {
    ...
    @Test
    func annotationAutomaticSyncUsesDeeplinkAndRestoresOriginallyClosedBooks() throws {
        let fixture = try fixture()
        defer { try? FileManager.default.removeItem(at: fixture.root) }
        ...
        let books = try AppleBooks(
            ...
            automaticAnnotationSync: true
        )

        let result = try books.updateAnnotationNote(uuid: "uuid-user", note: "automatic")
    ...
    @Test
    func injectedFacadeDefaultsToNoAutomaticAnnotationSync() throws {
        let fixture = try fixture()
        defer { try? FileManager.default.removeItem(at: fixture.root) }
